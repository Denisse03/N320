...
<!-- <RouterView  :sessions="sessions" @filterTag="filterTag" @filterPresenter="filterPresenter" @addSession="addSession"/> -->


<RouterView @add-session="addSession" :adds="adds" @remove-session="removeSession" :remove="remove" />
...
// import AllSession from './components/Allsession.vue'
...
filterPerson:[],
    ...
    components: { RouterView }
        ...
        filterPresenter( presenter){
            ...
            this.filterPerson = this.sessions.filter((session) => session.presenter.includes(presenter));
        ...
        addSession(session){
            this.adds.push(session);
            console.log('Added session:', this.adds);
