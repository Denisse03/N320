<template>
      ...
      <team-view  v-for="member in filterList" :key="member.id" :name="member.name" :phone="member.phone" :email="member.email" :role="member.role" :teamName="member.team" :currentTeam="currentTeam" @join-team="joinTeam"></team-view>
